...
function formatDuration (seconds) {
  ...
  if (days  === 1) {
    ...
    result = result === "" ? result + days + " days" : result + separator + days + " days";
  ...
  if (hours  === 1) {
    ...
    result = result === "" ? result + hours + " hours" : result + separator + hours + " hours";
  ...
  if (minuts  === 1) {
    result = result === "" ? result + "1 minute" : result + separator + "1 minute";
    
  }
  else if (minuts > 1) {
    result = result === "" ? result + minuts + " minutes" : result + separator + minuts + " minutes";
  ...
  if (sec  === 1) {
    ...
    result = result === "" ? result + sec + " seconds" : result + " and " + sec + " seconds";
